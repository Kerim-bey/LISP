...
Ранее описывалось, как установить редактор кода для Elm, поэтому следующим шагом является получение исполняемого файла с именем elm. Вы должны скачать файл для вашей операционной системы с https://guide.elm-lang.org/install/elm.html. 
